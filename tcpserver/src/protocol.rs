...
pub enum GameMessage {
    ...
    /// Heartbeat 메시지 (alias for debugging)
...
mod tests {
    ...
    fn test_message_serialization() {
        ...
        let bytes = msg.to_bytes().expect("Failed to serialize message in test");
        let decoded =
            GameMessage::from_bytes(&bytes).expect("Failed to deserialize message in test");
    ...
    fn test_heartbeat_response() {
        ...
        let bytes = msg
            .to_bytes()
            .expect("Failed to serialize HeartBeatResponse in test");
        let decoded = GameMessage::from_bytes(&bytes)
            .expect("Failed to deserialize HeartBeatResponse in test");
