...
use shared::service::redis::hepler::{
    cash_helper::CacheHelper, geo_helper::GeoHelper, hash_helper::HashHelper,
    list_helper::ListHelper, set_helper::SetHelper, zset_helper::ZSetHelper,
};
...
async fn test_geo_helper() -> Result<()> {
    ...
    geo.add_location(500, "seoul", 126.9780, 37.5665, &location1)
        .await?;
    geo.add_location(500, "busan", 129.0756, 35.1796, &location2)
        .await?;
    geo.add_location(500, "incheon", 126.7052, 37.4563, &location3)
        .await?;
